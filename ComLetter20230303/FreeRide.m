...
axis([0 3.0 1e-6 1]);%横纵坐标范围

set(gcf, 'PaperSize', [width height]);           % set size of PDF page
set(gcf, 'PaperPosition', [0 0 width height]);  


% print(figure(1), '-depsc', '/home/jack/公共的/MATLAB/ComLetter20230303/WER.eps');%保存为eps格式的图片color
% print(figure(1), '-dpdf', '/home/jack/公共的/MATLAB/ComLetter20230303/WER.pdf');%保存为pdf格式的图片color

% set(gcf, 'PaperSize', [25 25]);
% f = gcf;


exportgraphics(figure(1),'/home/jack/公共的/MATLAB/ComLetter20230303/AnnotatedPlot.pdf','ContentType','vector')
